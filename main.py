...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        file_menu_item = self.menuBar().addMenu("&File") # Menu
        edit_menu_item = self.menuBar().addMenu("&Edit") # Menu
        help_menu_item = self.menuBar().addMenu("&Help") # Menu
        ...
        self.table.setHorizontalHeaderLabels(("Id", "Name", "Course", "Mobile")) # Table
    ...
    def load_data(self):
        ...
        for row_number, row_data in enumerate(result):
            print(row_data)  # imprime as linhas da tabela
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        ...
        confirmation_widget.setText("The record was deleted sucessfully!")
